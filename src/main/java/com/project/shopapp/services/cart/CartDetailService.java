...
public class CartDetailService implements ICartDetailService {
    ...
    public CartDetail createCartDetail(CartDetailDTO cartDetailDTO) throws Exception {
        ...
        CartDetail cartDetail = CartDetail.builder()
                ...
                .numberOfProducts(cartDetailDTO.getNumberOfProduct())
    ...
    public CartDetail updateCartDetail(Long id, CartDetailDTO cartDetailDTO) throws Exception {
        ...
        existingCartDetail.setNumberOfProducts(cartDetailDTO.getNumberOfProduct());
    ...
    public CartDetail updateCartDetailNumberOfProduct(Long id, int numberOfProduct) throws Exception {
        ...
        existingCartDetail.setNumberOfProducts(existingCartDetail.getNumberOfProducts() + numberOfProduct);
        existingCartDetail.setUpdatedAt(LocalDateTime.now());
