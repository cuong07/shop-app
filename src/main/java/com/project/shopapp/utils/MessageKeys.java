...
public class MessageKeys {
    ...
    public static final String PASSWORD_NOT_MATCH = "user.login.password_not_match";
...
//    categories
    ...
    public static final String CATEGORY_GET_SUCCESSFULLY = "category.get_category.get_successfully";
    ...
    public static final String CATEGORY_UPDATE_FAILED = "category.update_category.update_failed";
